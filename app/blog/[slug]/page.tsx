...
export const dynamicParams = true; // allow any slug with mock fallback
...
<p className="mt-2 text-gray-600">Try browsing the <a href="/blog" className="text-emerald-700 underline">blog</a>.</p>
</main>
);
}
...
{/* Above-the-fold CTA */}
<InlineCTA variant="demo" sub="See how teams use our dashboard for roadmap, pricing, and packaging decisions." />
...
{/* Subscribe */}
<div className="mt-12"><SubscribeStrip /></div>
</article>
</main>
);
}