    ...
    return (
      <div className="space-y-6">
        <section className="rounded-[32px] border border-white/70 bg-white/90 p-6 shadow-[0_18px_60px_-35px_rgba(15,23,42,0.4)]">
          <SectionHeader
            eyebrow="EcoFocus Overview"
            title={`Operations workspace for ${access.user.name.split(" ")[0]}`}
            description="Use this internal view to manage client-facing dashboard access, monitor support activity, and keep EcoFocus review work separate from client reporting."
            actions={
              <>
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-4">
            <div className="rounded-[28px] bg-slate-950 p-5 text-white">
              ...
              <p className="mt-2 text-sm text-slate-300">Managed from the internal workspace</p>
            </div>
            <div className="rounded-[28px] border border-emerald-100 bg-[linear-gradient(135deg,#f0fdf4_0%,#ecfeff_100%)] p-5">
              ...
              <p className="mt-2 text-sm text-slate-600">Internal access spans the full dashboard library</p>
            </div>
        ...
        <section className="grid gap-6 xl:grid-cols-[1.1fr_0.9fr]">
          <div className="space-y-6">
            <div className="rounded-[32px] border border-slate-200 bg-white p-6">
              <SectionHeader
                eyebrow="Internal Actions"
                title="Operate the client workspace"
                description="Support-admin actions are grouped here so EcoFocus work stays distinct from client self-service flows."
              />
              <div className="mt-6 grid gap-4 md:grid-cols-2">
                <Link href="/portal/admin/support" className="rounded-[28px] border border-slate-200 bg-slate-50 p-5 transition hover:border-emerald-300 hover:bg-emerald-50/60">
                  ...
                  <p className="mt-3 text-sm leading-6 text-slate-600">
                    Review all tickets, assignments, allowance exceptions, and operational timelines from one internal view.
                  </p>
                </Link>
                <Link href="/portal/admin/dashboards" className="rounded-[28px] border border-slate-200 bg-slate-50 p-5 transition hover:border-emerald-300 hover:bg-emerald-50/60">
                  ...
                  <p className="mt-3 text-sm leading-6 text-slate-600">
                    Replace company Displayr URLs, review embed audit activity, and export incident records when needed.
                  </p>
                </Link>
              </div>
            </div>
            ...
            <div className="rounded-[32px] border border-slate-200 bg-white p-6">
              <SectionHeader
                ...
                description="Internal support access is centralized here, while client-side activity remains isolated to each company workspace."
              />
              <div className="mt-6 grid gap-4 md:grid-cols-2">
          ...
          <div className="space-y-6">
            <div className="rounded-[32px] border border-slate-200 bg-white p-6">
              <SectionHeader
                ...
                description="These tickets are visible from the internal queue and do not represent client consumption reporting."
              />
            ...
            <div className="rounded-[32px] border border-slate-200 bg-white p-6">
              <SectionHeader
                ...
                description="A lightweight view of non-session activity so EcoFocus members can spot changes without mixing in client viewing time."
              />
