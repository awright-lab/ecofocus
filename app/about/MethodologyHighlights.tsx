...
export default function MethodologyHighlights() {
  ...
  return (
    <section className="relative section-slab-emerald" aria-labelledby="methodology">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-14 md:py-16">
        <motion.h2
          ...
          className="mb-8 text-center font-bold leading-tight text-white text-[clamp(1.6rem,5.2vw,2.2rem)]"
        >
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          {rows.map((r, i) => (
            <motion.div
              ...
              className="rounded-2xl border border-white/20 bg-white p-6 shadow-lg"
            >
