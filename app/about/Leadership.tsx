...
type Person = {
  ...
  title: string;
  img: string;
  blurb: string;   // short front blurb
  details?: string; // optional longer back content
};
  ...
  const people: Person[] = [
    {
      ...
      details:
        "With a career spanning brand strategy and agency leadership, Jerry brings a pragmatic lens to sustainability. He focuses on turning research into roadmaps and aligning teams around measurable outcomes.",
    },
    {
      name: "Michael Croft",
      ...
      details:
        "Michael partners with account and strategy leads to pinpoint where EcoFocus data can move the needle—audience sizing, proof-points, and message frameworks that convert.",
    },
    {
      name: "Elinor Gaida",
      ...
      details:
        "Elinor architects our mixed-method designs and decision frameworks. She specializes in closing the say–do gap with clear, testable guidance.",
    },
    {
      name: "Allison Duncan",
      ...
      details:
        "Allison turns complex data into concise stories—prioritizing what to do next, not just what the chart says.",
    },
    {
      name: "Arif Wright",
      ...
      details:
        "Arif leads our dashboards, data viz, and design system—so stakeholders get clarity at a glance and depth on demand.",
    },
    {
      name: "Alex Murrey",
      ...
      details:
        "Alex builds the data and AI pipelines that speed up learning cycles while keeping quality, transparency, and governance front-and-center.",
    },
  ];

  // track which card is flipped (index -> boolean)
  ...
  return (
    <section className="relative section-slab-deep" aria-labelledby="leadership">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-14 md:py-16">
        {/* Catchier title with highlighted word */}
        <motion.h2
          id="leadership"
        ...
        >
          Meet the <span className="bg-gradient-to-r from-blue-500 via-teal-400 to-emerald-500 bg-clip-text text-transparent animate-gradient">Team</span> Behind the Work
        </motion.h2>
        ...
        >
          A senior team dedicated to translating sustainability insights into agency-ready strategies,
          with the rigor and clarity to stand up in the boardroom.
        </motion.p>
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {people.map((p, i) => {
            ...
            // For reduced motion, we don't rotate — we just expand a details pane.
            if (reduceMotion) {
              return (
                <motion.article
                  key={p.name}
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  >
                    {/* FRONT */}
                    <div className="absolute inset-0 overflow-hidden rounded-2xl border border-white/15 bg-white shadow-lg [backface-visibility:hidden]">
                      <div className="relative aspect-square">
                        <Image
                          src={p.img}
                          alt={p.name}
                    ...
                    {/* BACK */}
                    <div
                      className="absolute inset-0 rounded-2xl border border-white/15 bg-white shadow-lg p-5 [transform:rotateY(180deg)] [backface-visibility:hidden] flex flex-col"
      ...
      {/* Local styles for perspective fix on Safari/iOS */}
      <style jsx>{`
        .perspective {
          perspective: 1200px;
        }
