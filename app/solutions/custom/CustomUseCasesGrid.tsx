...
const useCases: UseCase[] = [
  {
    ...
    title: "For CMOs",
    points: [
      "Validate claims, messages, and value propositions before going to market.",
      "Identify the sustainability and purpose cues that drive choice and preference.",
    ],
  },
  {
    icon: <Lightbulb className="w-6 h-6 text-emerald-700" />,
    title: "Insights & Strategy Teams",
    points: [
      "Deep-dive into emerging consumer needs, tensions, and motivations.",
      "Translate behavioral signals into product, portfolio, and brand decisions.",
    ],
  },
  {
    ...
    points: [
      "Test new concepts, packaging, and formats with the right target audience.",
      "Pinpoint which sustainability features add meaningful value or differentiation.",
    ],
  },
  {
    ...
    points: [
      "Understand how different claims land across segments—from eco-active to eco-casual.",
      "Strengthen ESG narratives with consumer evidence that reduces risk of greenwashing.",
    ],
  },
];
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-16 md:py-20">
        ...
        <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-black/10 bg-gray-100 px-3 py-1 text-[10px] tracking-wide">
          <span
            ...
            aria-hidden="true"
          />
          <span className="text-black/60">Who We Support</span>
        </div>
        ...
        <div className="mt-0 md:mt-2 grid grid-cols-1 md:grid-cols-12 md:items-end gap-4 md:gap-6">
          ...
          >
            Custom Studies put EcoFocus insights to work—across brand, innovation,
            sustainability, and strategy—so teams move forward with clarity and confidence.
          </motion.p>
        </div>
                ...
                <div className="px-6 pb-6">
                  <ul className="grid gap-1.5">
                    {u.points.map((p) => (
                      <li
                        key={p}
                        className="relative pl-5 text-[15px] text-slate-700 leading-relaxed"
                      >
                        <span
                          aria-hidden
