...
const groups = [
  {
    ...
    points: [
      'Concept and claim testing for new products and platforms.',
      'Category and whitespace mapping anchored in sustainability attitudes.',
      'Persona and journey development that integrates eco-mindsets.',
    ],
  },
  {
    title: 'Talent & Culture',
    points: [
      'EVP validation and message alignment with next-gen talent.',
      'Values-driven retention insights for high-priority roles.',
      'Culture and change-management diagnostics tied to purpose.',
    ],
  },
  {
    title: 'Customer & Shopper',
    points: [
      'Path-to-purchase and channel preference work.',
      'In-store and digital communication testing.',
      'Pricing, pack, and assortment decisions informed by values.',
    ],
  },
  {
    title: 'Corporate & ESG',
    points: [
      'Materiality inputs grounded in consumer expectations.',
      'Stakeholder perception tracking over time.',
      'Storytelling that connects ESG initiatives to real behaviors.',
    ],
  },
];
