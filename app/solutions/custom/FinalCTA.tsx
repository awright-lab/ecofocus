    ...
    <section className="relative bg-gray-50" aria-labelledby="cta-custom">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 py-14">
        ...
        <p className="mx-auto mt-3 max-w-2xl text-center text-gray-600">
          We’ll start with a quick discovery call to understand your goals,
          audiences, and timelines. From there, we’ll shape a custom research
          plan and deliverables aligned to your budget and decision needs.
        </p>
