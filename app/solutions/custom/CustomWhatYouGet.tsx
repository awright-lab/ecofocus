// app/solutions/custom/CustomWhatYouGet.tsx
'use client';
    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-16 md:py-20">
        ...
        <div className="mt-0 md:mt-2 grid grid-cols-1 md:grid-cols-12 md:items-end gap-4 md:gap-6">
          ...
          >
            From initial brief to final storydeck, we design custom work to answer the questions that matter
            most—linking sustainability attitudes and behaviors directly to your positioning, concepts, packs,
