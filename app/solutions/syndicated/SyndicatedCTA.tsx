    ...
    <section className="relative bg-brand-tint-blue" aria-labelledby="syn-cta">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-14 md:py-16">
        ...
        <div className="mt-6 flex flex-col items-center justify-center gap-3 sm:flex-row">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center justify-center rounded-full relative overflow-hidden min-h-[44px] bg-[#FFC107] px-5 py-3 sm:py-2.5 text-sm font-semibold text-white transition-all duration-300
                           touch-manipulation
                           before:absolute before:inset-0 before:rounded-full before:bg-[radial-gradient(circle_at_center,_#FFD54F,_#FFA00)]
                           before:scale-0 before:transition-transform before:duration-500 hover:before:scale-110 before:z-0"
          >
