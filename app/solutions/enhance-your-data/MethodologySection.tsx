...
export default function MethodologySection() {
  ...
  const stats: Stat[] = [
    ...
    { label: 'National Benchmarks', value: 'Available', icon: 'ri-group-line', theme: 'slate' },
    { label: 'Syndicated Backbone', value: '±1.55%', icon: 'ri-equalizer-line', theme: 'marigold' },
    { label: 'Custom Integration Setup', value: 'Tailored', icon: 'ri-calendar-line', theme: 'emerald' },
  ];

  return (
    <section aria-labelledby="integration-methodology" className="relative bg-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-16 sm:py-20">
        ...
        >
          Data Integration Powered by Rigor
        </motion.h2>
        ...
        >
          Anchored by our nationally representative syndicated dataset, EcoFocus enhances your data with
          validated sustainability attitudes, behaviors, and psychographics.
        </motion.p>

        <motion.div
          layout
          className="mt-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 md:gap-8"
        >
          {stats.map((stat, i) => {
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10 px-5 py-6 sm:px-6 sm:py-7 flex items-center sm:block gap-4">
                  <span className={`inline-flex h-12 w-12 items-center justify-center rounded-xl ${t.iconWrap}`}>
