...
const faqs = [
  {
    q: "Do you require PII for joins?",
    a: "No. We support hashed IDs and aggregated merges. Many integrations do not require PII.",
  },
  {
    q: "What formats do you deliver?",
    a: "CSV or Parquet with schema and data dictionary. Secure bucket or API delivery is available on eligible plans.",
  },
  {
    q: "Can joined data appear in the Dashboard?",
    a: "Yes. We can enable a module so teams filter, segment, and export white-label charts using the joined dataset.",
  },
  {
    q: "How long does a typical integration take?",
    a: "Most projects complete in 1–3 weeks depending on scope, data readiness, and governance steps.",
  },
  {
...
export default function FAQIntegration() {
  return (
    <section className="relative bg-white" aria-labelledby="integration-faq">
