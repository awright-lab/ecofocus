...
export default function DashboardPromo() {
  return (
    <section className="py-24 bg-gradient-to-br from-[#124734] to-[#1D3557]">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
              Explore Every <span className="text-emerald-400">Insight</span>
            </h2>
            ...
            <div className="space-y-4 mb-10">
              {[
                ...
                <div key={i} className="flex items-center gap-4 p-4 bg-white/10 backdrop-blur-lg rounded-xl border border-white/10">
