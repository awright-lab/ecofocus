...
export default function ReportsCTA() {
  const r = useReducedMotion();

  return (
    <section className="relative bg-brand-tint-blue" aria-labelledby="reports-cta">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-14 md:py-16">
        ...
        >
          Can’t find the exact read you need?
        </motion.h2>
        ...
        >
          We can scope a brief, add a module to the dashboard, or merge your client data for a sharper
          answer—without starting from scratch.
        </motion.p>
        ...
        <div className="mt-6 flex flex-col items-center justify-center gap-3 sm:flex-row">
          ...
          <Link
            ...
            className="relative inline-flex items-center justify-center gap-2 rounded-full bg-[#FFC107] px-6 py-3 text-sm font-semibold text-emerald-950 shadow-md transition-all duration-300
                       ...
                       before:scale-0 before:transition-transform before:duration-500 hover:before:scale-110 before:z-0"
          >
            <span className="relative z-10">Explore custom research</span>
          </Link>
        </div>
      </div>
    </section>
